...
import { getNomenclatureHistoryTool, getNomenclatureHistory, } from './tools/get-nomenclature-history.js';
...
import { visualizeComparisonTool, visualizeComparison, } from './tools/visualize-comparison.js';
import { getAlleleCitationsTool, getAlleleCitations, } from './tools/get-allele-citations.js';
// Tool registry
const tools = [
    searchAllelesTool,
    getAlleleTool,
...
const toolHandlers = {
    ...
    list_locus_alleles: async (args) => listLocusAlleles(listLocusAllelesTool.inputSchema.parse(args)),
    ...
    download_sequences: async (args) => downloadSequences(downloadSequencesTool.inputSchema.parse(args)),
    get_alignment: async (args) => getAlignment(getAlignmentTool.inputSchema.parse(args)),
    get_nomenclature_history: async (args) => getNomenclatureHistory(getNomenclatureHistoryTool.inputSchema.parse(args)),
    check_allele_expression: async (args) => checkExpression(checkExpressionTool.inputSchema.parse(args)),
    find_ambiguous_pairs: async (args) => findAmbiguousPairs(findAmbiguousPairsTool.inputSchema.parse(args)),
    compare_alleles: async (args) => compareAlleles(compareAllelesTool.inputSchema.parse(args)),
    visualize_comparison: async (args) => visualizeComparison(visualizeComparisonTool.inputSchema.parse(args)),
    get_allele_citations: async (args) => getAlleleCitations(getAlleleCitationsTool.inputSchema.parse(args)),
};
