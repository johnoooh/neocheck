...
export async function getAlignment(input) {
    ...
    if (alleles && alleles.length > 0) {
        ...
        if (sequences.length === 0) {
            throw new Error(`None of the requested alleles found in alignment. ` +
...
export const getAlignmentTool = {
    name: 'get_alignment',
    description: 'Retrieve pre-computed multiple sequence alignments for HLA alleles from the IMGT/HLA database',
    inputSchema: getAlignmentSchema,
    handler: getAlignment,
};
//# sourceMappingURL=get-alignment.js.map