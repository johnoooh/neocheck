...
<style>
body {{ font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; margin: 2rem; color: #262730; }}
h1 {{ color: #1f77b4; }}
h2 {{ color: #333; border-bottom: 2px solid #1f77b4; padding-bottom: 0.3rem; }}
...
.metric {{ background: #f0f2f6; padding: 1rem; border-radius: 8px; text-align: center; flex: 1; }}
.metric .value {{ font-size: 2rem; font-weight: bold; color: #1f77b4; }}
.metric .label {{ color: #666; }}
.disclaimer {{ background: #fff3cd; border: 1px solid #ffc107; padding: 1rem; border-radius: 8px; margin: 1rem 0; }}
</style>
</head>
<body>
