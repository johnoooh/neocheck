...
export async function getSequence(input) {
    ...
    if (!sequence) {
        throw new Error(`No ${sequence_type} sequence available for allele ${allele}. ` +
...
//# sourceMappingURL=get-sequence.js.map