...
export async function getAlleleCitations(input) {
    const { allele } = input;
...
export const getAlleleCitationsTool = {
    ...
    description: 'Get PubMed citations for an HLA allele. Returns PubMed IDs that can be used with ' +
...
//# sourceMappingURL=get-allele-citations.js.map