...
export async function searchTcellAssays(input) {
...
export const searchTcellTool = {
    ...
    description: 'Search T-cell assay results in CEDAR for specific epitopes. Filter by peptide sequence, mutation, MHC allele, assay type (IFNg, ELISPOT, cytotoxicity, etc.), or qualitative result. Returns assay details including MHC restriction, host organism, immunization context, and TCR CDR3 sequences.',
    inputSchema: searchTcellSchema,
    handler: searchTcellAssays,
};
//# sourceMappingURL=search-tcell.js.map